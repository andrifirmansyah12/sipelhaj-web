    ...
    <div class="card card-body shadow-xl mx-3 mx-md-4 mt-n6">
        <div class="container">
                ...
                <section id="haji" class="haji">
                    <div class="description">
                        ...
                        <div class="shadow p-3 border bg-light mt-3 rounded">
                            ...
                            <p style="text-align: justify; text-justify: inter-word;">Paket Umrah Reguler selama 9 Hari.
                                Jamaah akan menginap selama 3 malam di Madinah Al
                                Munawarah dan 4 malam di Makkah Al Mukarramah. Selama di Madinah Al Munawarah, jamaah
                                akan
                                diagendakan ziarah ke beberapa tempat yang memiliki nilai Syiar Islam seperti Masjid
                                Quba,
                                Jabal Uhud, Masjid Qiblatain, Khandaq, Percetakan Al Qur’an & Kebun Kurma. Adapun di
                                Makkah
            ...
            <div class="info info-horizontal">
                ...
                <section id="haji" class="haji">
                    <div class="description">
                        <h4 class="info-title ps-3">Umrah Ramadhan</h4>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="card mx-1" style="width: 18rem;">
                                <img src="https://img.inews.co.id/media/822/files/inews_new/2021/07/14/haji1.jpg"
                                    class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title text-center">Umrah Ramadhan</h5>
                                </div>
                            </div>
                            <div>
                                <div class="bg-light p-4 rounded row">
